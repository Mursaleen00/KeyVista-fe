...
const Footer = () => {
  return (
    <div className='flex pb-20 pt-11 px-5 sm:px-16 justify-center items-center w-full'>
      <div className='relative -z-20 flex flex-col lg:flex-row bg-footer-gradient justify-between lg:px-10 rounded-3xl pt-3 w-full lg items-center'>
